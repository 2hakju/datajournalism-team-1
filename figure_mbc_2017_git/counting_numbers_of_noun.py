...
pro5_lines1 = read_textfile(pro5, 1)
pro5_lines2 = read_textfile(pro5, 2)
pro5_lines3 = read_textfile(pro5, 3)
pro5_lines4 = read_textfile(pro5, 4)
pro5_lines = pro5_lines1 + pro5_lines2 + pro5_lines3 + pro5_lines4

pro6_lines1 = read_textfile(pro6, 1)
pro6_lines2 = read_textfile(pro6, 2)
pro6_lines3 = read_textfile(pro6, 3)
pro6_lines4 = read_textfile(pro6, 4)
...
morph_1 = get_morph_list(pro5_lines1)
morph_2 = get_morph_list(pro5_lines2)
morph_3 = get_morph_list(pro5_lines3)
morph_4 = get_morph_list(pro5_lines4)
morph_all = get_morph_list(pro5_lines)
...
make_countfile(pro5, '1', countdict_1)
make_countfile(pro5, '2', countdict_2)
make_countfile(pro5, '3', countdict_3)
make_countfile(pro5, '4', countdict_4)
make_countfile(pro5, '_all', countdict_all)


morph_1 = get_morph_list(pro6_lines1)
morph_2 = get_morph_list(pro6_lines2)
morph_3 = get_morph_list(pro6_lines3)
morph_4 = get_morph_list(pro6_lines4)
morph_all = get_morph_list(pro6_lines)
...
make_countfile(pro6, '1', countdict_1)
make_countfile(pro6, '2', countdict_2)
make_countfile(pro6, '3', countdict_3)
make_countfile(pro6, '4', countdict_4)
make_countfile(pro6, '_all', countdict_all)
